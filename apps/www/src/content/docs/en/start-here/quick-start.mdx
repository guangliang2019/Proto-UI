...
The CLI is expected to be ready by **May 14, 2026**, and the first public launch is also currently targeted for **May 14, 2026**. For now, the commands, folder structure, and setup flow in this document are provided only to explain the intended future workflow. Do not run these installation commands yet. :::
