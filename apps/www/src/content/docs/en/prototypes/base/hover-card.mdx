...
import { codeMap } from '@/content/docs/demo_components/base-hover-card/baseHoverCardCode';
...
<div data-adapter-panel="wc">
  <PrototypePreviewer
    ...
    runtimes={['wc']}
    hasCode={true}
    code={getCode('wc', 'demo-base-hover-card', codeMap)}
  />
</div>
...
<div data-adapter-panel="react" style="display:none;">
  <PrototypePreviewer
    ...
    runtimes={['react']}
    hasCode={true}
    code={getCode('react', 'demo-base-hover-card', codeMap)}
  />
</div>
...
<div data-adapter-panel="vue" style="display:none;">
  <PrototypePreviewer
    ...
    runtimes={['vue']}
    hasCode={true}
    code={getCode('vue', 'demo-base-hover-card', codeMap)}
  />
</div>
